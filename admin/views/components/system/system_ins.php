                                    ...
                                    <div class="portlet-body">
                                        <form method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <input name="sort" type="text" class="col-sm-2 form-control" id="nm3" placeholder="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input name="title" type="text" class="form-control" id="inputEmail3" placeholder="">
                                                </div>
                                            </div>
                                            ...
                                            <fieldset class="form-group">
                                                <div class="row">
                                                 ...
                                                 <div class="customUi-radio radioUi-primary  ">
                                                    <input id="gr1" type="radio"  name="state" value="1">
                                                    <label for="gr1">
                                                ...
                                                <div class="customUi-radio radioUi-primary  ">
                                                    <input id="gr2" type="radio" name="state" value="0">
                                                    <label for="gr2">
                                                        <span class="label-radio"></span>
